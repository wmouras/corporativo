...
class PessoaJuridica extends Model
{
    ...
    protected $fillable = ['fk_id_pessoa', 'codigo_registro', 'razao_social', 'nome_fantasia', 'cnpj', 'fk_id_tipo_empresa', 'fk_id_tipo_estabelecimento', 'capital_social', 'dt_ultima_alt_capital', 'capital_filial', 'nr_ultima_alt_contratual', 'dt_ultima_alt_contratual', 'objetivo_social', 'observacoes', 'usuario', 'data_cadastro', 'data_alteracao'];
