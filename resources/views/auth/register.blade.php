<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="nu_cpf" value="{{ __('CPF') }}" />
                <x-jet-input id="nu_cpf" class="block w-full mt-1" type="text" name="nu_cpf" :value="old('nu_cpf')" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="nu_celular" value="{{ __('Celular') }}" />
                <x-jet-input id="nu_celular" class="block w-full mt-1" type="text" name="nu_celular" :value="old('nu_celular')" required />
            </div>
